...
from src.core.exceptions import InventoryManagementError
...
class ErrorHandlingMiddleware(BaseHTTPMiddleware):
    ...
    async def handle_exception(self, request: Request, exc: Exception) -> JSONResponse:
        ...
        if isinstance(exc, InventoryManagementError):
            error_response = self._handle_inventory_error(exc, request, correlation_id)
    ...
    def _handle_inventory_error(
        self,
        exc: InventoryManagementError,
        request: Request,
        correlation_id: str | None,
    ) -> ErrorResponse:
        """Handle custom inventory management errors."""
